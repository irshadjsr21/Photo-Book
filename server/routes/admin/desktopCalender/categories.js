...
router.post('/', validator.desktopCalenderCategory, categoriesController.postDesktopCalenderCategory);
...
router.put('/:id', validator.desktopCalenderCategory,categoriesController.putDesktopCalenderCategory);
