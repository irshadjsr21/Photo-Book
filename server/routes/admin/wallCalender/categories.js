...
router.post('/', validator.wallCalenderCategory, categoriesController.postWallCalenderCategory);

router.get('/', categoriesController.getWallCalenderCategory);

router.delete('/:id', categoriesController.deleteWallCalenderCategory);

router.put('/:id', validator.wallCalenderCategory,categoriesController.putWallCalenderCategory);
