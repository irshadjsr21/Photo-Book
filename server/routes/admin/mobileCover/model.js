...
router.post('/', validator.mobileCoverModel, modelController.postMobileCoverModel);

router.get('/', modelController.getMobileCoverModel);

router.delete('/:id', modelController.deleteMobileCoverModel);

router.put('/:id', validator.mobileCoverModel, modelController.putMobileCoverModel);
