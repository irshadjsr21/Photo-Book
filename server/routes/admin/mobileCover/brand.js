...
router.post('/', validator.mobileCoverBrand, brandController.postMobileCoverBrand);

router.get('/', brandController.getMobileCoverBrand);

router.delete('/:id', brandController.deleteMobileCoverBrand);

router.put('/:id', validator.mobileCoverBrand,brandController.putMobileCoverBrand);
