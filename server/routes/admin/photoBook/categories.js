...
router.post('/', validator.photoBookCategory, categoriesController.postPhotoBookCategory);

router.get('/', categoriesController.getPhotoBookCategory);

router.delete('/:id', categoriesController.deletePhotoBookCategory);

router.put('/:id', validator.photoBookCategory,categoriesController.putPhotoBookCategory);
